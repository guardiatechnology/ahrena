...
|-------|:-----------:|-----------|
| Requisitos (ACs) | Sí | `docs/issues/issue-{n}/02-requirements.md` o lista equivalente |
...
- [ ] 6. Persistir en docs/issues/issue-{n}/02b-test-plan.md
...
Estructura en `docs/issues/issue-{n}/02b-test-plan.md`:
...
|-------|---------|---------|
| Plan de pruebas estructurado | Markdown | `docs/issues/issue-{n}/02b-test-plan.md` |
...
- **Destino fijo**: `docs/issues/issue-{n}/02b-test-plan.md` (siguiendo convención de `lex-issue-driven`).
