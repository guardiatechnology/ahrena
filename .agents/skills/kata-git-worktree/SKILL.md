...
description: "Criar e Gerenciar Git Worktree. Criação, uso e remoção de git worktrees para tarefas baseadas em branch, conforme lex-git-worktrees"
---
...
- Diretório: `.worktrees/42-scheduled-payments-api/`
...
```powershell
# 1. Navegar para a raiz do repositório (se dentro do worktree)
Set-Location ../..
...
| Output | Descrição |
|--------|-----------|
| Worktree criado | Diretório `.worktrees/{issue-number}-{slug}/` com o branch ativo |
