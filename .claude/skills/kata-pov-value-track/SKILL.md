...
description: "Track PoV Value (value-proof.md). Engineering — Agents (pre-operational stage): structured data capture during PoV operation to support the go/no-go decision to promote to operational-concrete"
---
