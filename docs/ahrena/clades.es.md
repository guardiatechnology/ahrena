# Ahrena — Clades & Subclades

Catálogo completo de clades y subclades con cobertura de pilares y conteo de artefactos.

> **Los enlaces** apuntan a la versión en inglés en `framework/en/`. Todo artefacto también existe en `framework/pt-BR/` y `framework/es/`.

---

## `_foundation` — Transversal

Reglas y procedimientos que se aplican a todas las disciplinas. Prefijado con `_` para ordenar primero y señalar autoridad transversal.
...
Guardia's visual identity and product design system standards.
...
Rules and procedures for producing and translating technical documentation.
...
Technical standards covering all engineering disciplines at Guardia.
...
| Clade | Subclades | Total de Artefactos (en) |
|---|---|---|
| `_foundation` | 6 | ~116 |
| `design` | 2 | ~14 |
| `documentation` | 1 | ~11 |
| `engineering` | 9 | ~86 |
| **Total** | **18** | **~227 (× 3 idiomas = ~649)** |
