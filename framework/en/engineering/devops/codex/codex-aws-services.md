...
AWS offers more than 200 services. Choosing the right service for a problem is a central part of a solutions architect's work. This Codex maps common use cases to recommended services, with alternatives and trade-offs, serving as a reference for `warrior-atlas` during architectural design and review.

## Context

- **Domain:** operational AWS services catalog
- **Target audience:** `warrior-atlas`, DevOps agents
- **Update:** when new services emerge or when practices change (e.g., Lambda SnapStart, Graviton, Serverless v3)
...
- `lex-aws-security`, `lex-aws-iac`, `lex-aws-cost` — applicable Lexis
