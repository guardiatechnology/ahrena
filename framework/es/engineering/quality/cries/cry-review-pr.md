...
- Fase 0: Recolectar PR, Issue vinculado, PRD/Capability Spec en Notion (cuando estén disponibles), `.issues/{N}/` local, y el plan referenciado
...
Fase 0 — Recolección: Issue #138 ✅ | PRD en Notion ✅ | .issues/138/ ✅
