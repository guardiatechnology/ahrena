...
- [ ] El nombre del archivo usa el prefijo del Pilar definido en `naming.prefixes.katas` (consultar `.directives`) y kebab-case
...
- `codex-pilars` — Lista de validación para Katas (sección Validación de artefatos)
