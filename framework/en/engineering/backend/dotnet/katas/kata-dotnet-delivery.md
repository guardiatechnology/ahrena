...
Perform .NET work by discovering the repository contract, modeling proportionally, testing by risk, and completing operational validation.

## When to Use

- To implement a feature or fix in C#/.NET
- To review or refactor .NET code
- To diagnose build, runtime, data, or production failures

## Inputs

| Input | Required | Description |
|---|:---:|---|
| Mode | Yes | `implement`, `review`, `refactor`, or `debug` |
| Objective | Yes | Behavior, diff, or failure in scope |
| Evidence | No | Issue, logs, stack trace, contract, metrics, or reproduction |
