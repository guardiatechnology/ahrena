...
description: "Desenhar Schema de Dados. Desenho de schema para nova entidade, domínio ou expansão de modelo existente — entidades, relacionamentos, índices, migrations, retenção"
---
...
Estrutura em `.ahrena/issues/{n}/03b-schema.md` (complementa architecture.md):
...
|-------|---------|---------|
| Documento de schema | Markdown | `.ahrena/issues/{n}/03b-schema.md` |
