...
| Contexto | No | Issue, ACs, arquitectura esperada (viniendo de `docs/issues/issue-{n}/` si aplica) |
...
3. Si hay ACs (flujo Issue-Driven), leer `docs/issues/issue-{n}/02-requirements.md`.
