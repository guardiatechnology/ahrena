...
description: "Curate PoV Context Pack. Engineering — Agents (pre-operational stage): curate few-shot examples + domain negative examples to feed the PoV's context"
---
