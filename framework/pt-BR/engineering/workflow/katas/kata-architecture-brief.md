...
|-------|:-----------:|-----------|
| Brief Fase 1 | Sim | `docs/issues/issue-{n}/01-brief.md` |
...
- [ ] 7. Persistir em docs/issues/issue-{n}/03-architecture.md
- [ ] 8. Atualizar checkpoint
```

### Passo 1: Ler brief + requisitos

1. Ler `01-brief.md` e `02-requirements.md` em `docs/issues/issue-{n}/`.
...
### Passo 7: Persistir em `docs/issues/issue-{n}/03-architecture.md`
...
|-------|---------|---------|
| Documento de arquitetura | Markdown | `docs/issues/issue-{n}/03-architecture.md` |
...
- **Destino fixo:** `docs/issues/issue-{n}/03-architecture.md` e `docs/adr/ADR-*` (conforme `lex-issue-driven`).
