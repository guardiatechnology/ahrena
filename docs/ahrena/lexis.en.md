# Ahrena — Lexis Catalog

All **39** unbreakable laws in the Ahrena framework.

> **Links** point to the English version in `framework/en/`. Every Lexis also exists in `framework/pt-BR/` and `framework/es/`.
