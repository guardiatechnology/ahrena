...
Rules for ordering listings in Guardia platform APIs: allowed properties, indexes, stable ordering, and partitioning. Used together with pagination.

## Context

- **Domain:** ordering of resources in paginated listings on the Guardia platform.
- **Target audience:** API implementers and consumers.
- **Update trigger:** when the Hub sorting specification changes.
...
- OAS
- [codex-restful-apis](codex-restful-apis.md) (index); [codex-restful-pagination](codex-restful-pagination.md)
