...
description: "Revisão de Design de API RESTful. Plataforma Guardia — revisão de contratos de API HTTP existentes contra as Lexis e Codex da Guardia"
---
...
Para cada operação que modifica estado (POST, PATCH):
