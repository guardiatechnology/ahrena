...
2. Listar **Active plans** — para cada plano em uso na sessão, gerar entrada `\`plan-NNN\` — slug; 1-line context ≤ 80 chars`. Inferir do contexto ou consultar `.claude/plans/plan-*.md` ativos (status `in-progress`).
