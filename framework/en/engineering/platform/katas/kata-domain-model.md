...
| Module name | Yes | Guardia module identifier (e.g., `platform`, `reconciliation`, `fiscal`) |
| Known entities | No | Entities already identified; if provided, validate and extend from them |
| Bounded context scope | No | Single or multiple contexts; if omitted, agent determines from description |
