...
Guardia's experience is **agentic by default**. Isac is the center of interaction — not an assistant bolted onto a classic SaaS. The user describes the result; the agent plans, executes, and reports. The UI exists to make this readable, controllable, and auditable. This Codex consolidates principles, layout pattern, usage rules, examples, and Design System implications.

## Context

- **Domain:** user experience in main product (platform and app), with permanent Isac presence.
- **Target audience:** designers, frontend, mobile, product, AI agents that produce UI (warrior-hephaestus, warrior-iris).
- **Update trigger:** when the *AI-First Experience* page in Notion is revised.
