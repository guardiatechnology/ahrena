---
name: kata-skill-implement
description: "Implement Skill. Orchestration of the authoring phase of a skill project at {paths.skills_root}/{slug}/, delegating widgets to warrior-hephaestus and Python tools/scripts to warrior-apollo, while authoring SKILL.md + references/ directly"
---
