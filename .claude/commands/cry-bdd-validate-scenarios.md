Validate BDD Scenario Coverage in the Test Suite. Standalone — confirms that every business BDD scenario in a GitHub issue has at least one covering test (by canonical marker or fallback)
