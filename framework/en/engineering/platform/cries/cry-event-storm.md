...
- `kata-events-doc` — Procedure executed by the Kronos Warrior (the Kata consults the Lexis and Codex for events, entities, and idempotency; see Kata documentation)
