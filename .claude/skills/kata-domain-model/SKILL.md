...
description: "Domain Modeling (DDD). Guardia platform — domain discovery and modeling for a feature or module using Domain-Driven Design"
---
...
**Integration Events:** `event.guardia.financial.scheduled_transfer.requested`, `.approved`, `.executed`, `.failed`, `.cancelled`
