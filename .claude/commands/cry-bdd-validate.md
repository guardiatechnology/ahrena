BDD Validation (Phase 8). Engineering — Quality. Shortcut that invokes warrior-themis to run Phase 8 of the Issue-Driven flow (scenario design + validation against the implementation) and return the go
