...
Estrutura unificada para respostas de sucesso e erro em requisições HTTP da plataforma Guardia. Aplicável a todas as requisições HTTP da plataforma.

## Contexto

- **Domínio:** estrutura do corpo de resposta (data, pagination, errors, debug).
- **Público-alvo:** implementadores e consumidores de APIs.
- **Atualização:** quando a especificação de payload no Hub for alterada.
