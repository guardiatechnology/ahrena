...
O **AWS Well-Architected Framework** é o conjunto de princípios, melhores práticas e perguntas estruturais que a AWS publica para guiar o design de workloads em nuvem. Este Codex resume os 6 pilares, suas questões-chave e os trade-offs comuns, servindo como referência para `warrior-atlas` ao projetar ou revisar arquiteturas.

## Contexto

- **Domínio:** arquitetura de soluções AWS
- **Público-alvo:** `warrior-atlas`, agentes DevOps, revisores de arquitetura
- **Atualização:** quando a AWS atualiza o framework (revisões anuais) ou quando novos serviços mudam práticas estabelecidas
...
- `lex-aws-security` — Pilar de Segurança como leis
- `lex-aws-cost` — Pilar de Custo como leis
- `lex-aws-iac` — Pilar de Operational Excellence
- `codex-aws-services` — serviços e escolhas por caso de uso
