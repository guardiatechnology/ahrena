---
description: "Start PR review with `purpose=review`. Shortcut to start a Claude Code PR-review session already tagged for the Review subsection of the cost stamp"
---
