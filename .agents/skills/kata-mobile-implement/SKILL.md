---
name: kata-mobile-implement
description: "Implementar Feature Mobile. Implementação de feature mobile em iOS e Android (paridade), com offline-first, acessibilidade, testes e observabilidade"
---
