...
Guardia adopts **Poppins** as its everyday typeface, **Lastica** as exclusive to the logos, and **Roboto** as the native fallback for restricted environments. This Codex consolidates hierarchy, channel use, installation, and CSS declaration.

## Context

- **Domain:** typographic identity in any channel (UI, decks, documents, social media, email, app).
- **Target audience:** designers, frontend, mobile, marketing, sales, AI agents that produce text-bearing pieces.
- **Update trigger:** when the *Tipografia* page in Notion is revised.
...
- Poppins (Google Fonts, SIL OFL); Roboto (Apache 2.0); Lastica (proprietary)
- Typographic tokens in `@guardia/design-system`
