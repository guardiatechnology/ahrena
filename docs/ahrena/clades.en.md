...
Complete catalog of clades and subclades with pilar coverage and artifact counts.

> **Links** point to the English version in `framework/en/`. Every artifact also exists in `framework/pt-BR/` and `framework/es/`.
...
| Clade | Subclades | Total Artifacts (en) |
|---|---|---|
| `_foundation` | 6 | ~116 |
| `design` | 2 | ~14 |
| `documentation` | 1 | ~11 |
| `engineering` | 9 | ~86 |
| **Total** | **18** | **~227 (× 3 languages = ~649)** |
