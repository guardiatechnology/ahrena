...
description: "Context Pack Design (with `--from-pov` Bridge). Engineering — Agents: design of the agent's context pack (context-pack.md) in operational-concrete, including the canonical bridge that consumes warrior-claudionor output (PoV → Operational Concrete)"
---
