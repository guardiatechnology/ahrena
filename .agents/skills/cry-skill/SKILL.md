---
name: cry-skill
description: "Ciclo de Skill (implement / validate / package). Atalho para invocar warrior-claudionor e conduzir o ciclo implement → validate → package de um projeto de skill Anthropic Agent Skills"
---
