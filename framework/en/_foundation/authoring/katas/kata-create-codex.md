...
This Kata defines the standardized procedure for creating a new Codex in Ahrena — from defining the knowledge domain to creating the artifact in all three mandatory languages.

## When to Use

- When it is necessary to document domain knowledge for consultation by AI agents
- When the user explicitly requests the creation of a new Codex
- When invoked by `cry-new-codex`

## Inputs

| Input | Required | Description |
|-------|:--------:|-------------|
| Domain | Yes | Knowledge area to document (e.g., "system architecture", "API patterns") |
| Target audience | No | Who consults this Codex. If omitted, assumes "AI agents and developers" |
| Clade/Subclade | No | Where to save in the taxonomy. If omitted, the agent MUST infer from the domain |
...
- `codex-pilars` — Validation checklist for Codex (Artifact validation section)
- `codex-codex` — Quality criteria for Codex
...
- `templates/codex-sample.md` — Official template
