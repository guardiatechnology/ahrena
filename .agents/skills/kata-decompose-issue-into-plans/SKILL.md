...
description: "Decompor Issue em Sub-issues Plan. Decomposição de uma Issue parent (User Story, Bug, Tech Task) em N sub-issues Plan executáveis, conforme lex-agent-planning"
---
