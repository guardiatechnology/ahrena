...
Este manual define as ferramentas de desenvolvimento padrão para projetos Python backend. Ferramentas consistentes em todo o time eliminam debates de estilo, detectam bugs cedo e automatizam a aplicação de qualidade. Cada ferramenta é configurada uma vez e executada automaticamente — os desenvolvedores se concentram na lógica, não na formatação.

## Context

- **Domain:** ferramentas de desenvolvimento e automação de qualidade para projetos Python.
- **Target audience:** implementadores e agentes de IA que configuram ou mantêm ferramentas de projetos Python.
- **Update trigger:** quando ferramentas são atualizadas ou novas ferramentas são adotadas.
...
| Termo | Definição |
|-------|-----------|
| Ruff | Linter e formatador Python extremamente rápido escrito em Rust |
| mypy | Verificador estático de tipos para Python |
| pre-commit | Framework para gerenciar git pre-commit hooks |
| pip-audit | Ferramenta para varrer dependências Python por vulnerabilidades conhecidas |
