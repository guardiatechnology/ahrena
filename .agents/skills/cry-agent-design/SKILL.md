---
name: cry-agent-design
description: "Design Canônico de Agent em Operação Concreta. Engenharia — Agents: entry point para conduzir promoção de PoV → operational-concrete ou direct-entry em produção, sob orquestração de warrior-metis"
---
