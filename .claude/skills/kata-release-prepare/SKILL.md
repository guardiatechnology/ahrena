...
description: "Prepare Release (Bump + Changelog). Phase 1 of the release cycle orchestrated by warrior-janus — commit analysis, SemVer bump proposal, changelog generation, and trunk-state verification"
---
...
1. Identify the trunk branch (default: `main`).
2. Check CI status on the target commit:
   ```bash
