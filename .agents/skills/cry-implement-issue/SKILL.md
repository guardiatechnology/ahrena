---
name: cry-implement-issue
description: "Implementar Issue (Issue-Driven Development). Ponto de entrada do fluxo Issue-Driven Development — invoca warrior-athena para conduzir a issue do GitHub pelas 7 fases até a criação do PR"
---
...
- Variáveis de ambiente: `GH_TOKEN` (obrigatório) e `NOTION_API_KEY` (opcional)
