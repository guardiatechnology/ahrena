...
description: "Síntese de Insights de Discovery. Product Discovery — leitura de fontes heterogêneas e produção de insights estruturados sob docs/discovery/{topic}/insights/"
---
