...
description: "Preparar Release (Bump + Changelog). Fase 1 do ciclo de release orquestrado por warrior-janus — análise de commits, proposta de bump SemVer, geração de changelog e verificação de estado do trunk"
---
