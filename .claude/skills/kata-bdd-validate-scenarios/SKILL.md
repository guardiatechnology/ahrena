---
name: kata-bdd-validate-scenarios
description: "BDD Coverage — Issue #{n}. Standalone — confirms that every business BDD scenario in a GitHub issue is covered by at least one test, by canonical marker or fallback"
---
