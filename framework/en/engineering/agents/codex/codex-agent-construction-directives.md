...
- **Related Codex:**
  - `codex-agent-design-docs` — **operational manual** for the canonical 13-file template (`system-prompt.md`, `tools.md`, `metrics.md`, `memory.md`, `guardrails.md`, etc.); this Codex describes the **conceptual rigor per Directive**, the other prescribes the **physical structure**
