...
description: "Análise de Issue. Fase 1 do fluxo Issue-Driven — leitura da issue do GitHub e busca de contexto relacionado no Notion"
---
...
4. Confirmar `GH_TOKEN` e `NOTION_API_KEY` (se aplicável) definidas no ambiente.
