...
description: "Publicar Release (Tag Anotada + GitHub Release). Fase 2 do ciclo de release orquestrado por warrior-janus — criação de tag anotada/assinada, push para o remoto, espera/edição do release via GitHub Action e verificação de pós-condições"
---
