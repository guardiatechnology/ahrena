...
This Codex provides practical guidance for translating technical documentation across any language combination. It is the cross-cutting guide that complements `lex-language` (translation law) and precedes the language-specific guides (`codex-language-ptbr`, `codex-language-en`, `codex-language-es`).

## Context

- **Domain:** Technical documentation translation
- **Audience:** `warrior-translator` (Hermes) and any agent performing translations
- **Updates:** whenever new cross-cutting conventions are established
...
- `lex-language` — Cross-cutting translation law
- `lex-language-ptbr`, `lex-language-en`, `lex-language-es` — Per-language laws
- `codex-language-ptbr`, `codex-language-en`, `codex-language-es` — Per-language guides
- `kata-translate` — Coordination procedure
- `warrior-translator` — Translation agent (Hermes)
