...
description: "Design do Orchestrator e Reasoning Loop. Engenharia — Agents: design do orquestrador do agent em operational-concrete, produzindo orchestrator.md e reasoning-loop.md"
---
