...
A AWS oferece mais de 200 serviços. Escolher o serviço certo para um problema é parte central do trabalho do arquiteto de soluções. Este Codex mapeia casos de uso comuns aos serviços recomendados, com alternativas e trade-offs, servindo como referência para `warrior-atlas` durante design arquitetural e revisão.

## Contexto

- **Domínio:** catálogo operacional de serviços AWS
- **Público-alvo:** `warrior-atlas`, agentes DevOps
- **Atualização:** quando novos serviços emergem ou quando práticas mudam (ex.: Lambda SnapStart, Graviton, Serverless v3)
...
- `lex-aws-security`, `lex-aws-iac`, `lex-aws-cost` — Lexis aplicáveis
