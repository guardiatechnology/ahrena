...
- **Domain:** Design of AI agents with defined identity and scope
- **Audience:** AI agents executing `kata-create-warrior` and framework maintainers
- **Update:** When new quality standards are identified for Warriors
...
| Term | Definition |
|------|------------|
| Persona | Set of behavioral characteristics that define the Warrior's tone |
| Consultation chain | Set of Lexis, Codex, and Katas that the Warrior references |
| Escalation | Transfer of a decision to a human when the Warrior reaches its limits |
| Scope | Delimitation of what the Warrior does and does not do |
