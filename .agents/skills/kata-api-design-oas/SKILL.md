---
name: kata-api-design-oas
description: "Design de API RESTful para Nova Feature — Especificação OpenAPI (OAS). Plataforma Guardia — design de APIs REST e produção de especificação OpenAPI 3.x"
---
