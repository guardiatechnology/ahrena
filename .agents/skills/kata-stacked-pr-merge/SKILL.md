...
description: "Merge Bottom-Up de Stacked PRs. Mergear uma cadeia de Pull Requests encadeados na ordem correta (base → topo), atualizando explicitamente o base da próxima camada após cada merge, usando gh + git (caminho vanilla)"
---
