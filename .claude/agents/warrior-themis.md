---
name: warrior-themis
description: "Themis — Senior BDD Validation Engineer. Engineering — Quality. Phase 8 behavioral validation in the Issue-Driven flow via Gherkin scenarios derived exclusively from specification sources."
---
