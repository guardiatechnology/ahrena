...
Este Codex orienta decisões de Domain-Driven Design sem transformar DDD em estrutura de pastas ou catálogo obrigatório de patterns. O ponto de partida é o domínio: linguagem, fronteiras, ownership e invariantes; patterns táticos entram apenas quando a complexidade os justifica.

## Contexto

- **Domínio:** design de bounded contexts, modelos e integrações
- **Público-alvo:** engenharia, produto, especialistas de domínio e agentes de design
- **Atualização:** quando mudar a arquitetura por componentes, a taxonomia de entidades ou o contrato de eventos
...
| Termo | Definição |
|---|---|
| Bounded Context | Limite em que uma linguagem e um modelo têm significado consistente |
| Invariante | Regra que deve permanecer verdadeira durante uma mudança de estado |
| Context Map | Relações e direção de dependência entre bounded contexts |
| Hotspot | Ambiguidade ou conflito que requer descoberta adicional |
