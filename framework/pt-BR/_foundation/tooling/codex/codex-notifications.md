...
| `notifications.channels.plans_status` | `warrior-eunomia` (plan-044) | Digest periódico de planos ativos no loop PM |
...
2. Habilitar via `make mcp-enable SERVER={novo}` (per plan-042).
