...
description: "Extrair tokens de design e specs do Figma via MCP. Extração de tokens de design (cores, espaçamentos, tipografia) e especificações de componentes de um arquivo Figma via servidor MCP"
---
