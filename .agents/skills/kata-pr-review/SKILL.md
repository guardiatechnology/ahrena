---
name: kata-pr-review
description: "Iniciar uma Sessão de Revisão de PR (com `purpose=review` no stamp de custo). Iniciar uma sessão Claude Code para revisar uma Pull Request, garantindo que os turnos sejam contabilizados na seção Review do stamp de custo (kata-pr-cost-stamp)"
---
