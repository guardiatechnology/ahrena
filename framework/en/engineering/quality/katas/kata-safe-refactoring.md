...
Produce a small, reversible, evidence-protected refactoring with an explicit decision about the smell, chosen pattern, and cost.

## When to Use

- When complexity, duplication, coupling, or naming obstructs a change
- Before introducing a structural pattern
- When legacy code must be prepared for a behavior change

## Inputs

| Input | Required | Description |
|---|:---:|---|
| Target | Yes | Files, component, or behavior to improve |
| Motivation | Yes | Blocked change, recurring defect, or observed risk |
| Constraints | No | Contracts, performance, data, and compatibility to preserve |
