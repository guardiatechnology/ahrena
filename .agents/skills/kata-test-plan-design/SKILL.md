...
description: "Desenhar Plano de Testes. Desenho de plano de testes para uma feature — distribui ACs pelos níveis certos, define cobertura esperada, identifica riscos e gaps"
---
...
- [ ] 6. Persistir em .ahrena/issues/{n}/02b-test-plan.md
...
Estrutura em `.ahrena/issues/{n}/02b-test-plan.md`:
...
|-------|---------|---------|
| Plano de testes estruturado | Markdown | `.ahrena/issues/{n}/02b-test-plan.md` |
...
- **Destino fixo**: `.ahrena/issues/{n}/02b-test-plan.md` (seguindo convenção de `lex-issue-driven`).
