...
Any additional inbound mutation edge MUST route through its own edge interceptor or be documented as exempt. Per-handler or per-service idempotency wiring is FORBIDDEN.
