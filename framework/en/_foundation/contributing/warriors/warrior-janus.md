...
- MCP `update_issue` — updates the release Issue body throughout the cycle (Janus operates on Axis B; the `kata-flush-plan-to-subissue` kata is specific to Plan sub-issues on Axis A)
