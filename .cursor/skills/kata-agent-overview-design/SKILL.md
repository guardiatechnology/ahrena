...
description: "Agent Overview Design (Identity + Consolidated System Prompt). Engineering — Agents: design of the canonical identity of an agent in operational-concrete, producing overview.md (governance header) and system-prompt.md (per lex-system-prompt)"
---
