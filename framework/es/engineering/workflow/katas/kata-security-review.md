...
Ejecutar revisión de seguridad sobre el código implementado en la Fase 4, identificando vulnerabilidades conocidas (OWASP Top 10), problemas de autenticación/autorización, exposición de datos sensibles, credenciales en código y dependencias con CVEs conocidos. Produce informe en `.ahrena/issues/{n}/05-security-review.md` con severidad clasificada; los hallazgos críticos bloquean el Gate 2.
...
| Arquitectura Fase 3 | Sí | `.ahrena/issues/{n}/03-architecture.md` (incluye integraciones externas) |
...
- [ ] 7. Persistir en .ahrena/issues/{n}/05-security-review.md
...
### Paso 7: Persistir en `.ahrena/issues/{n}/05-security-review.md`
...
|--------|---------|---------|
| Informe de seguridad | Markdown | `.ahrena/issues/{n}/05-security-review.md` |
...
- **Destino fijo:** `.ahrena/issues/{n}/05-security-review.md` (según `lex-issue-driven`).
