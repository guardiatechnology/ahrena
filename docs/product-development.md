...
| [lex-frontend-accessibility](../framework/pt-BR/engineering/frontend/lexis/lex-frontend-accessibility.md), [lex-frontend-security](../framework/pt-BR/engineering/frontend/lexis/lex-frontend-security.md), [lex-frontend-typing](../framework/pt-BR/engineering/frontend/typescript/lexis/lex-frontend-typing.md), [lex-frontend-testing](../framework/pt-BR/engineering/frontend/lexis/lex-frontend-testing.md) | Verificadas por Mômos no wireframe HF / spec de componente; verificadas no Gate 2 sobre código de Hephaestus |
