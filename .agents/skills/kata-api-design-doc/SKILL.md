---
name: kata-api-design-doc
description: "Design de API RESTful para Nova Feature — Documento Estruturado (Markdown). Plataforma Guardia — design de APIs REST e produção de documento Markdown estruturado"
---
