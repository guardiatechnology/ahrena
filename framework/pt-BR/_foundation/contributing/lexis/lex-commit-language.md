...
O inglês é a língua franca da engenharia de software. Mensagens de commit em inglês garantem que qualquer contribuidor — independentemente do idioma nativo — consiga compreender o histórico do projeto. Ao mesmo tempo, permitir o corpo em idioma local com tag ajuda a mitigar erros de tradução.

Esta Lexis garante que a mensagem principal do commit seja em inglês, com opção de corpo em idioma local, conforme definido pelo CONTRIBUTING da Guardia.
...
1. **Bloqueio automático:** commit com subject em idioma não-inglês é sinalizado
2. **Alerta:** revisor solicita correção do subject
3. **Remediação:** reescrever com `git commit --amend`
...
- [CONTRIBUTING da Guardia — Idiomas](https://hub.guardia.finance/docs/community/CONTRIBUTING/)
