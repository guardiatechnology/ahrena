...
description: "Carregar Plano a partir da Sub-issue. Materialização do cache local provider-specific (.claude/plans/plan-{M}-{slug}.md ou .cursor/plans/plan-{M}-{slug}.md) a partir do body canônico da sub-issue Plan, conforme o modelo hierárquico de lex-agent-planning"
---
