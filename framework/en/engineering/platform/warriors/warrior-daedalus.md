...
> Ensure that every new HTTP API on the Guardia platform is designed consistently with RESTful Lexis and Codex, **in iterative dialogue with the user**, asking clarifying questions and refining the design until it meets the required criteria, producing OpenAPI specification and API document — clear, complete, and ready for implementation.
