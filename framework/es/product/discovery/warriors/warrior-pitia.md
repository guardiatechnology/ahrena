...
- No altera `status` de insight a cualquier valor distinto de la creación inicial en `proposed` — toda otra transición exige dirección humana per HARD-GATE 2 de la `lex-discovery-flow`
