---
name: kata-bdd-create-scenarios
description: "Author BDD Business Scenarios from Issue and Notion. Standalone — produces business-focused BDD scenarios from a GitHub issue and Notion, then writes them back into the issue body"
---
