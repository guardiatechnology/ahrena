...
- `kata-release-prepare` — Fase 1 (análise + proposta)
- `kata-release-publish` — Fase 2 (publicação após aprovação)
- `lex-annotated-tags` — Lei que governa a validade da tag empurrada
- `lex-semantic-version`, `lex-signed-commits`, `lex-conventional-commits` — Lexis consultadas em todo o fluxo
