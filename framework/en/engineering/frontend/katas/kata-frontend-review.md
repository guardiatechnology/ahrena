...
| Context | No | Issue, ACs, expected architecture (coming from `docs/issues/issue-{n}/` if applicable) |
...
3. If there are ACs (Issue-Driven flow), read `docs/issues/issue-{n}/02-requirements.md`.
