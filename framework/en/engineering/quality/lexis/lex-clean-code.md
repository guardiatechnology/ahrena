...
Prevent noise, dead code, and uncontrolled complexity from hiding actual behavior. This Lexis covers objective criteria only; contextual design decisions belong in `codex-code-design`.
...
- **Applies to:** production code, tests, scripts, and executable examples
- **Bound agents:** every agent that implements, refactors, or reviews code
