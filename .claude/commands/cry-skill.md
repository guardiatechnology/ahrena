Skill Cycle (implement / validate / package). Shortcut to invoke warrior-claudionor and run the implement → validate → package cycle of an Anthropic Agent Skills project
