...
Texto preto sobre Amarelo 500 (13.06:1, AAA); texto Branco sobre Cinza 500 (11.24:1, AAA); botão Violeta 500 com label Branco (>7:1); badge Laranja 500 com texto Violeta 500 reservado a botões/títulos (3.96:1, AA grande); gráfico de variação financeira usando Verde Sinal/Vermelho Sinal apenas no eixo de dados.

### Incorreto

Texto branco sobre Amarelo 500 (1.61:1, ilegível); cor "roxa aproximada" inventada para complementar o brand; verde institucional usado como cor de marca em hero; uso de #4F186D fora da paleta tokenizada (hardcoded ao lado de cores não-aprovadas).
