...
- **Señaliza `ready_for_dooc`** en `value-proof.md::Decisión actual` cuando el PoV maduró — abre camino para Mêtis ejecutar `kata-dooc-validate`
...
Próximos pasos:
  ...
  2. Cuando value-proof.md::status = ready_for_dooc, invocar:
