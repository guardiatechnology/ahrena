...
description: "Orchestrator and Reasoning Loop Design. Engineering — Agents: design of the agent's orchestrator in operational-concrete, producing orchestrator.md and reasoning-loop.md"
---
