...
Este Codex é o guia prático para traduzir documentação técnica **para Português Brasileiro (pt-BR)**. Complementa a `lex-language-ptbr` (regras obrigatórias) com orientações, exemplos e tabelas de referência.

## Contexto

- **Domínio:** Tradução técnica para pt-BR
- **Público-alvo:** `warrior-translator` e agentes que traduzam para pt-BR
- **Atualização:** sempre que novas convenções para pt-BR forem identificadas
...
- `lex-language-ptbr` — Regras obrigatórias (este Codex complementa)
