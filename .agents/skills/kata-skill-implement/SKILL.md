...
description: "Implementar Skill. Orquestração da fase de autoria de um projeto de skill em {paths.skills_root}/{slug}/, delegando widgets a warrior-hephaestus e tools/scripts Python a warrior-apollo, e redigindo SKILL.md + references/ diretamente"
---
