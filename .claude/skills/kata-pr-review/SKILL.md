---
name: kata-pr-review
description: "Start a PR Review Session (with `purpose=review` on the cost stamp). Start a Claude Code session to review a Pull Request, ensuring the turns are counted in the Review subsection of the cost stamp (kata-pr-cost-stamp)"
---
