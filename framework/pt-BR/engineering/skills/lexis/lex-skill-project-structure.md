...
- **Agentes vinculados:** `kata-init-skill` (scaffold), `cry-new-skill` (atalho), `warrior-hephaestus` (widgets), `warrior-apollo` (scripts/tools Python), e qualquer agente que edite o projeto durante o ciclo dev → build → dist
