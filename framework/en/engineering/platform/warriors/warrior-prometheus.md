...
| `lex-entity-naming` | Consistency check: entity names across phases must match snake_case/PascalCase conventions |
...
|---------|-------|----------------|
| `warrior-theseus` | 1 — Domain Modeling | Ubiquitous Language, Bounded Contexts, Entities, Aggregates, Use Cases, Context Map |
| `warrior-daedalus` | 2 — API Design | OpenAPI specification and API document in paths.oas |
| `warrior-kronos` | 3 — Event Documentation | Formal CloudEvents document in paths.events |
