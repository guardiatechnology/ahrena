---
name: cry-full-design
description: "Design Completo — API e Eventos. Processo único que combina design de API REST e documentação de eventos CloudEvents para uma nova feature"
---
