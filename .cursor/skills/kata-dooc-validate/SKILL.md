...
description: "Definition of Operational Concrete (DoOC) Validation. Engineering — Agents: gate-keeping the promotion from pre-operational to operational-concrete per lex-agent-construction-directives"
---
...
1. `warrior-apollo-agents` is available (plan-013 merged — verify via existence of `framework/{lang}/engineering/backend/python/warriors/warrior-apollo-agents.md`) → ✅
