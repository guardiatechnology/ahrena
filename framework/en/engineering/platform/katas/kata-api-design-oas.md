...
This Kata defines the procedure to design the REST API for a new feature and **produce specification in OpenAPI 3.x format** (YAML or JSON): consult Lexis and Codex, identify resources and operations, define endpoints, and persist the contract in **paths.oas** in compliance with Guardia rules.
...
- When you need to generate or update an OAS file in `docs/oas` (or path defined in paths.oas)
